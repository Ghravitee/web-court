...
import brain from "../assets/image-brain-removebg.png";
import draft from "../assets/draft-documents-removebg.png";
import lawsuit from "../assets/lawsuit.png";
import lock from "../assets/lock.png";
import jury from "../assets/jury-remove-bg.png";
import stalk from "../assets/stalk-removebg.png";
...
const DumbedDownPage = () => {
  return (
    <section className="relative pt-16 md:pt-28 pb-8 md:pb-20 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="absolute top-10 left-2 md:left-10 w-24 h-24 md:w-40 md:h-40 bg-cyan-500/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-10 right-2 md:right-10 w-24 h-24 md:w-40 md:h-40 bg-purple-500/10 rounded-full blur-3xl"></div>
      <div className="absolute top-1/2 left-1/4 w-20 h-20 md:w-32 md:h-32 bg-yellow-500/5 rounded-full blur-3xl"></div>
      <div className="absolute left-2 md:left-28 top-10 w-24 h-24 md:w-40 md:h-40 md:size-[20rem] opacity-90 animate-float hidden sm:block">
        <img
          src={brain}
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-8 md:mb-16 px-2">
          <div className="inline-flex items-center gap-2 md:gap-3 mb-3 md:mb-6 px-3 md:px-6 py-2 md:py-4 rounded-lg md:rounded-2xl bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30">
          ...
          <div className="inline-flex items-start gap-2 md:gap-4 px-3 md:px-6 py-2 md:py-3 rounded-full bg-green-500/10 border border-green-500/30 mb-4 md:mb-8 max-w-full">
        ...
        <div className="space-y-6 md:space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                ...
                <div className="space-y-4 lg:col-span-2 lg:col-start-1 lg:col-end-3">
                  ...
                  <div className="relative">
                    ...
                    <motion.div
                      className="absolute -top-8 md:-top-[3rem] -left-12 md:-left-[10rem] size-16 md:size-32 lg:size-40 flex items-center justify-center z-10"
                      variants={slideEmoji}
                      initial="initial"
                      whileInView="animate"
                  ...
                  <div className="relative">
                    ...
                    <motion.div
                      className="absolute -bottom-8 md:-bottom-[10rem] -left-12 md:-left-[10rem] size-16 md:size-32 lg:size-40 flex items-center justify-center z-10"
                      variants={slideEmoji}
                      initial="initial"
                      whileInView="animate"
                      viewport={{ once: false, amount: 0.3 }}
                ...
                <div className="space-y-4 lg:col-span-2 lg:col-start-3 lg:col-end-5">
                  ...
                  <div className="relative">
                    ...
                    <motion.div
                      className="absolute -top-8 md:-top-[3rem] -right-12 md:-right-[10rem] size-16 md:size-32 lg:size-40 flex items-center justify-center z-10"
                      variants={slideEmoji}
                      initial="initial"
                      whileInView="animate"
                      viewport={{ once: false, amount: 0.3 }}
                  ...
                  <div className="relative">
                    ...
                    <motion.div
                      className="absolute -bottom-8 md:-bottom-[10rem] -right-12 md:-right-[10rem] size-16 md:size-32 lg:size-40 flex items-center justify-center z-10"
                      variants={slideEmoji}
                      initial="initial"
                      whileInView="animate"
                      viewport={{ once: false, amount: 0.3 }}
                ...
                <div className="relative lg:col-span-2 lg:col-start-2 lg:col-end-4 mt-4 lg:mt-0">
                  ...
                  <motion.div
                    className="absolute -bottom-8 md:-bottom-[12rem] left-0 right-0 mx-auto size-16 md:size-32 lg:size-40 flex items-center justify-center z-10"
                    variants={slideEmoji}
                    initial="initial"
                    whileInView="animate"
                    viewport={{ once: false, amount: 0.3 }}
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-2 sm:px-4 py-6 md:py-10">
            {/* Header / Content */}
            <div className="p-3 md:p-6 lg:p-8 flex flex-col items-center gap-3 md:gap-6">
              ...
              <p className="text-base sm:text-lg md:text-2xl font-bold text-center text-white px-2">
                Because humans lie. And degens lie professionally.
              </p>
            </div>

            {/* GIFs Section - Mobile responsive grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4 max-w-4xl mx-auto mt-4 md:mt-8">
              {/* Column 1 */}
              <div className="flex flex-col gap-2 md:gap-4">
                <img
                  src={gif1}
                  alt="Funny GIF 1"
                  className="rounded-lg md:rounded-xl shadow-lg w-full h-32 sm:h-40 md:h-48 object-cover"
                />
                <img
                  src={gif2}
                  alt="Funny GIF 2"
          ...
          <div className="space-y-6 lg:space-y-16">
            {/* Agreements */}
            <div className="bg-gradient-to-br from-green-500/30 to-black/50 p-4 md:p-6 border border-green-500/30 rounded-xl md:rounded-3xl max-w-4xl mx-auto">
              ...
              <p className="text-white text-sm md:text-base max-w-full md:max-w-[40rem] mx-auto mb-3 md:mb-4 text-center">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
                <div className="bg-gradient-to-br from-green-500/10 to-black/50 rounded-xl md:rounded-2xl p-4 md:p-6 border border-green-500/30">
                  ...
                  <div className="space-y-2 md:space-y-3">
                    <div className="flex items-center gap-2 md:gap-3 p-2 md:p-3 bg-black/30 rounded-lg">
                ...
                <div className="space-y-3 md:space-y-4">
                  <p className="text-white text-sm md:text-base mb-3 md:mb-4 font-medium">
                  ...
                  <div className="p-3 md:p-4 rounded-xl bg-black/50 border border-green-500/20">
                    <div className="space-y-2 md:space-y-3">
                      <div className="flex items-center gap-2 md:gap-3 p-2 md:p-3 bg-black/30 rounded-lg">
                        <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-green-500 flex items-center justify-center flex-shrink-0">
                          <span className="font-bold text-sm">1</span>
            ...
            {/* Escrow */}
            <div className="bg-gradient-to-br from-blue-500/30 to-black/50 p-4 md:p-6 border border-blue-500/30 rounded-xl md:rounded-3xl max-w-4xl mx-auto">
              <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-4 md:gap-8">
                <div className="flex-1 w-full">
                  <div className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-black/50 border border-blue-500/30 mb-4 md:mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                    <div className="bg-gradient-to-br from-blue-500/10 to-black/50 rounded-xl md:rounded-2xl p-4 md:p-6 border border-blue-500/30">
                      <h3 className="sec text-lg md:text-2xl font-bold text-white mb-3 md:mb-4 text-center">
                        With DexCourt escrow:
                      </h3>
                      <div className="space-y-3 md:space-y-4">
                        <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-black/30 rounded-lg">
                  ...
                  <div className="mt-6 md:mt-8 p-4 md:p-6 rounded-xl md:rounded-2xl bg-gradient-to-br from-blue-500/10 to-black/50 border border-blue-500/30">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 mb-4 md:mb-6">
                      <div className="p-3 md:p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 text-center">
            ...
            {/* Disputes */}
            <div className="bg-gradient-to-br from-purple-500/30 to-black/50 p-4 md:p-6 border border-purple-500/30 rounded-xl md:rounded-3xl max-w-4xl mx-auto">
              <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
              ...
              <div className="mb-6 md:mb-8">
                <div className="inline-block px-4 md:px-6 py-2 md:py-3 rounded-full bg-purple-500/20 border border-purple-500/30 mb-3 md:mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mt-4 md:mt-6">
                  <div className="space-y-3 md:space-y-4">
                    <div className="p-3 md:p-4 rounded-xl bg-gradient-to-br from-purple-700/20 to-black/50 border border-purple-500/30">
                ...
                <div className="mt-4 p-3 md:p-4 rounded-xl bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
                <div className="bg-gradient-to-br from-purple-500/10 to-black/50 rounded-xl md:rounded-2xl p-4 md:p-6 border border-purple-500/30">
                  <h3 className="sec text-lg md:text-2xl font-bold text-white mb-3 md:mb-4">
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-black/50 border border-purple-500/30">
                  ...
                  <div className="p-4 md:p-6 rounded-xl bg-gradient-to-r from-purple-500/10 to-black/50 border border-purple-500/30">
            ...
            {/* Voting */}
            <div className="bg-gradient-to-br from-yellow-500/30 to-black/50 p-4 md:p-6 border border-yellow-500/30 rounded-xl md:rounded-3xl max-w-4xl mx-auto">
              <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
                <div>
                  ...
                  <div className="space-y-3 md:space-y-4">
                    <div className="p-3 md:p-4 rounded-xl bg-gradient-to-br from-yellow-700/20 to-black/50 border border-yellow-500/30">
                ...
                <div className="p-3 md:p-4 rounded-xl bg-gradient-to-br from-yellow-700/20 to-black/50 border border-yellow-500/30">
                  ...
                  <div className="space-y-2 mt-2">
                    <h3 className="text-white mb-2 sec font-bold text-sm md:text-base">
                      This isn't:
                    </h3>
                    <div className="">
                    ...
                    <p className="text-base md:text-lg font-bold text-green-700 text-center">
            ...
            {/* Reputation System */}
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-orange-500/30 to-black/50 p-4 md:p-6 border border-orange-500/30 rounded-xl md:rounded-3xl">
              ...
              <div className="mb-3 md:mb-4">
                <p className="text-lg md:text-2xl font-bold text-white text-center mb-2">
                  Now the big question:
                </p>
                <p className="text-base md:text-xl font-bold text-white text-center mb-3 md:mb-4">
              ...
              <div className="grid lg:grid-cols-2 grid-cols-1 gap-3 md:gap-4">
                <div className="space-y-2 md:space-y-3 bg-gradient-to-br from-orange-500/10 to-black/50 rounded-xl md:rounded-2xl p-4 md:p-6 border border-orange-500/30">
                  <h3 className="text-base md:text-xl sec text-white">
                    Simple. DexCourt hits people where it hurts most: their
                    reputation.
                  </h3>
                  <div className="flex items-center gap-2 md:gap-3 p-2 md:p-3 bg-black/30 rounded-lg w-full md:w-fit">
                ...
                <div className="bg-gradient-to-br from-orange-500/10 to-black/50 rounded-xl md:rounded-2xl p-4 md:p-6 border border-orange-500/30">
                  <p className="text-gray-300 text-sm md:text-lg mb-3">
                    DexCourt becomes a public reputation database. Imagine:
                  </p>
                  <div className="grid grid-cols-1 gap-3">
                    <div className="p-3 md:p-4 rounded-lg bg-black/30">
        ...
        <div className="mt-8 md:mt-16 bg-gradient-to-br from-cyan-500/30 to-black/50 p-4 md:p-6 border border-cyan-500/30 rounded-xl md:rounded-3xl max-w-4xl mx-auto">
          <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            <div className="p-2 md:p-3 rounded-lg md:rounded-xl bg-cyan-500/20">
          ...
          <div className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-gradient-to-br from-cyan-500/10 to-black/50 border border-cyan-500/30">
