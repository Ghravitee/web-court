...
// const ParallaxStack = ({ children }: { children: React.ReactNode }) => {
//   return (
          ...
          <div className="max-w-4xl mx-auto py-2 md:pb-10">
            <div className="rounded-xl md:rounded-3xl p-3 md:p-6 lg:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                ...
                <div className="relative overflow-hidden lg:col-span-2 lg:col-start-2 lg:col-end-4 mt-4 lg:mt-0">
...
//         // How far the section has moved past the top
...
//           }}
//           key={index}
//           className="sticky top-24 transition-opacity duration-200"
...
// const DumbedDownPage = () => {
//   return (
//     <section className="relative pt-16 md:pt-28 pb-8 md:pb-20 px-4 sm:px-6">
//       {/* Fun Background Elements - Adjusted for mobile */}
//       <div className="absolute top-10 left-2 md:left-10 w-24 h-24 md:w-40 md:h-40 bg-cyan-500/10 rounded-full blur-3xl"></div>
//       <div className="absolute bottom-10 right-2 md:right-10 w-24 h-24 md:w-40 md:h-40 bg-purple-500/10 rounded-full blur-3xl"></div>
//       <div className="absolute top-1/2 left-1/4 w-20 h-20 md:w-32 md:h-32 bg-yellow-500/5 rounded-full blur-3xl"></div>
...
//           <ParallaxStack>
//             {/* Agreements */}
//             <div className="relative backdrop-blur-xl bg-gradient-to-br from-green-500/30 to-black/50 p-4 md:p-6 border border-green-500/30 rounded-xl md:rounded-3xl max-w-4xl mx-auto">
//               {/* <div className="absolute inset-0 bg-[#0b0f1a] rounded-3xl" /> */}
//               <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
//                 <div className="p-2 md:p-3 rounded-lg md:rounded-xl bg-green-500/20">
//                   <FileText className="w-6 h-6 md:w-8 md:h-8 text-green-400" />
//                 </div>
